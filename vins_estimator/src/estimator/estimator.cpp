...
void Estimator::optimization()
{
    ...
    // This workspace is built against a CPU Ceres backend.
    options.linear_solver_type = ceres::DENSE_SCHUR;
    if (USE_GPU_CERES)
    {
        ROS_WARN("use_gpu_ceres is enabled in config, but GPU Ceres is unavailable; falling back to CPU DENSE_SCHUR.");
    }
